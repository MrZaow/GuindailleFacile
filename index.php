...
/*Jeux les plus populaires*/
 $sql2 = "SELECT * FROM jeux ORDER BY jeux.popularite DESC LIMIT 10" ;
...
<div id="container">
    ...
    <div id="slider" class="slider1 hidden-xs">
    ...
    <!-- End slider -->
    <div id="lapin" class="hidden-sm hidden-md hidden-lg">
      <div class="section-content portfolio-section-section">
        <div class="container">
          <div class="container triggerAnimation animated" data-animate="bounceIn">
              <h1>Guindaille Facile, tout pour organiser une bonne soirée</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="section-content shortcodes-section">
            ...
            <div class="row">
              <div class="col-md-offset-3 col-sm-6">
                ...
                <form action="//guindaillefacile.us11.list-manage.com/subscribe/post?u=1ee15ca8e96867a8f69176901&amp;id=1b2cb6de55" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll">
                	<h2>Inscrivez-vous à notre liste de mail pour recevoir des conseils de notre part afin d'organiser vos soirées</h2>
                ...
                <div class="mc-field-group">
                    ...
                    <div style="position: absolute; left: -5000px;"><input type="text" name="b_1ee15ca8e96867a8f69176901_1b2cb6de55" tabindex="-1" value=""></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="testimonial-post">
                                    ...
                                    <p> “ Guindaille Facile me donne envie de me balancer complètement à poil sur une grosse boule. ”</p>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="testimonial-post">
