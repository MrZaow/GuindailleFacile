...
<head>
<title><?= $result['nom']; ?>, bière <?= $result['type']; ?> - les bières - Guindaille Facile</title>
<meta name="description" content="Tout ce qu'il faut savoir sur la bière <?= $result['nom']; ?>. Prix, avantages, inconvénients, bières similaires, et notre avis." />
</head>
...
(adsbygoogle = window.adsbygoogle || []).push({});
			...
			<div class="container comment-section">
			  <div class="title-section">
			    <div class="container triggerAnimation animated" data-animate="bounceIn">
						<h1>Votre avis à propos de la bière "<?= $result['nom']?>"</h1>
					</div>
			  </div>
