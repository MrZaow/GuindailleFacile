...
$req = $bdd->prepare("UPDATE boissons SET image3 = :image3 WHERE idingredient = $identre");
                    $req->execute(array(
                            'image3' =>$image3['name'],
                        ));
}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="modificationimage3.php" method="post" enctype="multipart/form-data">
