...
$req = $bdd->prepare("UPDATE boissons SET image1 = :image1 WHERE idingredient = $identre");
                    $req->execute(array(
                            'image1' =>$image1['name'],
                        ));
}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="modificationimage1.php" method="post" enctype="multipart/form-data">
