...
<head>
<title><?= $result['nom']; ?>, alcool fort - Guindaille Facile</title>
<meta name="description" content="Tout ce qu'il faut savoir sur l'alcool <?= $result['nom']; ?>. Prix, avantages, inconvénients, et les mélanges à base de <?= $result['nom']; ?>." />
</head>
					  ...
					  <br>
									...
									<div class="col-md-12">
										<div class="single-project-content">
											...
											<h3>Le <?=$result['nom'];?> est un alcool fort contenant <?= $result['pourcentagealcool']; ?> % d'alcool et coûtant en moyenne <?= $result['prixlitre']; ?> euros/litre en
												magasin (les prix varient selon les marques).</h3>
										</div>
									</div>
								</div>
						...
						<div class="col-md-5">
							<div class="flexslider">
								<ul class="slides">
									<li>
										<img src="images/min/<?= $result['image1']; ?>" alt="Première image de l'alcool <?= $result['nom'];?>">
									</li>
									<li>
										<img src="images/min/<?= $result['image2']; ?>" alt="Deuxième image de l'alcool <?= $result['nom'];?>">
									</li>
									<li>
										<img src="images/min/<?= $result['image3']; ?>" alt="Troisième image de l'alcool <?= $result['nom'];?>">
									</li>
								</ul>
							</div>
							<br><br>
...
(adsbygoogle = window.adsbygoogle || []).push({});
			...
			<div class="container comment-section">
			  <div class="title-section">
			    <div class="container triggerAnimation animated" data-animate="bounceIn">
						<h1>Votre avis à propos de l'alcool "<?= $result['nom']?>"</h1>
					</div>
			  </div>
