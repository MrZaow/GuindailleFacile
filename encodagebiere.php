                ...
                <div class="col-md-8">
                    ...
                    <form action="encodagebiere.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" required placeholder="Le pourcentage d'alcool" name="pourcentage" id="pourcentage" value="<?php if(isset($pourcentage)) echo $pourcentage; ?>" class="form-control">
                            <?php if(isset($error['pourcentage'])) echo $error['pourcentage']; ?>
                        </div>
                        <div class="form-group">
                            <label>Prix au litre</label><br>
                            <input type="number" required placeholder="Le prix au litre" name="prixaulitre" id="prixaulitre" value="<?php if(isset($prixaulitre)) echo $prixaulitre; ?>" class="form-control">
                            <?php if(isset($error['prixaulitre'])) echo $error['prixaulitre']; ?>
                        </div>
                        <div class="form-group">
                            <label>Cote sur 5</label><br>
                            <input type="number" required placeholder="La cote sur 5" name="cote" id="cote" value="<?php if(isset($cote)) echo $cote; ?>" class="form-control">
