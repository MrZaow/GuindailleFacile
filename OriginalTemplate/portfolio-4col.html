			...
			<div class="navbar navbar-default navbar-fixed-top">			
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="portfolio-4col.html#"><img alt="" src="images/logo.png"></a>
					</div>
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="drop"><a href="portfolio-4col.html#">Features</a>
								<ul class="drop-down">
									...
									<li class="drop"><a href="portfolio-4col.html#">Go Level 3</a>
										<ul class="drop-down level3">
											<li><a href="portfolio-4col.html#">Level 3</a></li>
											<li><a href="portfolio-4col.html#">Level 3</a></li>
											<li><a href="portfolio-4col.html#">Level 3</a></li>
											<li><a href="portfolio-4col.html#">Level 3</a></li>
										</ul>
							...
							<li><a href="http://nunforest.com/site/marble-demo/non-animation/blog.html">Blog</a>
								<ul class="drop-down">
									<li><a href="blog-fullwidth.html">Blog Fullwidth</a></li>
									<li><a href="blog-masonry.html">Blog Masonry</a></li>
									<li><a href="blog-with-sidebar.html">Blog Left Sidebar</a></li>
							...
							<li class="drop"><a href="portfolio-4col.html#" class="open-search"><i class="fa fa-search"></i></a>
			...
			<div class="section-content portfolio-section">
				...
				<div class="portfolio-box">
					<ul class="filter triggerAnimation animated" data-animate="bounceIn">
						<li><a href="portfolio-4col.html#" class="active" data-filter="*">All</a></li>
						<li><a href="portfolio-4col.html#" data-filter=".web-design">Web Design</a></li>
						<li><a href="portfolio-4col.html#" data-filter=".photography">Photography</a></li>
						<li><a href="portfolio-4col.html#" data-filter=".illustration">Illustration</a></li>
						<li><a href="portfolio-4col.html#" data-filter=".branding">Branding</a></li>
					</ul>
					...
					<ul class="bxslider">
						<li>
							<ul class="client-list">
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client1.png"></a></li>
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client2.png"></a></li>
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client3.png"></a></li>
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client4.png"></a></li>
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client5.png"></a></li>
								<li><a href="portfolio-4col.html#"><img alt="" src="images/client6.png"></a></li>
							</ul>
						</li>
						<li>
							<ul class="client-list">
		...
		<footer>
			<div class="social-section">
				<ul class="social-icons triggerAnimation animated" data-animate="tada">
					<li><a class="facebook" href="portfolio-4col.html#"><i class="fa fa-facebook"></i></a></li>
					<li><a class="twitter" href="portfolio-4col.html#"><i class="fa fa-twitter"></i></a></li>
					<li><a class="rss" href="portfolio-4col.html#"><i class="fa fa-rss"></i></a></li>
					<li><a class="google" href="portfolio-4col.html#"><i class="fa fa-google-plus"></i></a></li>
					<li><a class="linkedin" href="portfolio-4col.html#"><i class="fa fa-linkedin"></i></a></li>
					<li><a class="pinterest" href="portfolio-4col.html#"><i class="fa fa-pinterest"></i></a></li>
				</ul>
			</div>
			<div class="up-footer">
				<div class="container">
					<div class="row">
							...
							<div class="widget footer-widget tweets-widget">
								...
								<ul>
									<li>
										...
										<p>Photoshop to CSS3 magic - CSS Hat - <a href="portfolio-4col.html#">http://t.co/ad2CggDN</a> </p>
										<span>15 June 2012</span>
									</li>
									<li>
										<i class="fa fa-twitter"></i>
										<p>CrossFit Advanced - another well done website, featured on CSSLuxury -  <a href="portfolio-4col.html#">http://t.co/ad2CggDN</a> </p>
										<span>15 June 2012</span>
									</li>
								</ul>
							</div>
						...
						<div class="col-md-3">
							<div class="widget footer-widget flickr-widget">
								<h1>Flickr Stream</h1>
								<ul class="flickr">
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr1.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr2.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr3.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr4.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr5.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr6.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr2.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr3.jpg"></a></li>
									<li><a href="portfolio-4col.html#"><img alt="" src="upload/flickr1.jpg"></a></li>
								</ul>
