...
<div class="tp-banner" >
    <ul>	<!-- SLIDE  -->
        <li data-transition="3dcurtain-horizontal" data-slotamount="7" data-masterspeed="500" >
            <!-- MAIN IMAGE -->
            <img src="./App/Assets/upload/banners/slide1.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
        ...
        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
            <!-- MAIN IMAGE -->
            <img src="./App/Assets/upload/banners/back5.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
            <!-- LAYER NR. 1 -->
            <div class="tp-caption large_bold_white skewfromrightshort customout"
                 data-x="374"
        ...
        <li data-transition="curtain-1" data-slotamount="7" data-masterspeed="600" >
            <!-- MAIN IMAGE -->
            <img src="./App/Assets/upload/banners/back6.jpg" style='background-color:#b2c4cc' alt=""  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
            <!-- LAYER NR. 1 -->
            <div class="tp-caption large_bold_white skewfromrightshort customout"
                 data-x="15"
        ...
        <li data-transition="flyin" data-slotamount="7" data-masterspeed="800" >
            <!-- MAIN IMAGE -->
            <img src="./App/Assets/upload/banners/back.jpg" style='background-color:#b2c4cc' alt=""  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
        ...
        <div id="owl-demo" class="owl-carousel owl-theme">
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img1.jpg">
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img2.jpg">
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img3.jpg">
            ...
            <div class="item project-post ">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img4.jpg">
                    <a href="#">
                        <p>Infos</p>
                    </a>
                </div>
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img5.jpg">
                    <a href="#">
                        <p>Infos</p>
                    </a>
                </div>
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img6.jpg">
                    <a href="#">
                        <p>Infos</p>
                    </a>
                </div>
            ...
            <div class="item project-post">
                <div class="project-gal">
                    <img alt="" src="./App/Assets/upload/portfolio/img7.jpg">
                    <a href="#">
                        <p>Infos</p>
                    </a>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="testimonial-post">
                            <img src="./App/Assets/upload/testim1.jpg" alt="">
                    ...
                    <div class="col-sm-4">
                        <div class="testimonial-post">
                            <img src="./App/Assets/upload/testim2.jpg" alt="">
                    ...
                    <div class="col-sm-4">
                        <div class="testimonial-post">
                            <img src="./App/Assets/upload/testim3.jpg" alt="">
