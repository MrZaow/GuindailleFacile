        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="suppressioncocktail.php" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label>ID du cocktail</label>
                            <input type="number" required class="form-control" name="identre" id="identre" placeholder="L'id du cocktail" value="<?php if(isset($identre)) echo $identre; ?>" autofocus>
