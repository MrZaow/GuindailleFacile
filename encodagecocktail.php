        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="encodagecocktail.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea col="120" required placeholder="La préparation" name="preparation" id="preparation" value="<?php if(isset($preparation)) echo $preparation; ?>" class="form-control"></textarea>
                            <?php if(isset($error['preparation'])) echo $error['preparation']; ?>
                        </div>
