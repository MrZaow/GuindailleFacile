...
$result = "Ajout d'inconvénient réalisé avec succes";
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="encodageinconvenient.php" method="post" enctype="multipart/form-data">
