...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 08 Mai 2015 à 18:30
...
CREATE TABLE IF NOT EXISTS `cocktails` (
  ...
  `idingredient` int(11) NOT NULL,
  `alcoolfortprincipal` varchar(30) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`idingredient`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
('Pressez le jus d''un demi-citron, ajoutez dans le shaker avec les autres ingrédients et des glaçons. Frappez puis versez dans le verre en filtrant. Afin qu''il soit plus frais et léger, remplissez auparavant le verre de glace pilée.', 43, 'gin'),
('Placer les feuilles de menthe dans le verre, ajoutez le sucre et le jus de citrons. Piler consciencieusement afin d''exprimer l''essence de la menthe mais sans la broyer. Ajouter le rhum, remplir le verre à moitié de glaçons et compléter avec de l''eau gazeuse. Mélanger doucement et servir avec une paille.', 48, 'vodka'),
('Dans un blender (mixer), versez les ingrédients avec 5 ou 6 glaçons et mixez le tout. C''est prêt ! Versez dans le verre et dégustez. Peut aussi se réaliser au shaker si c''est juste pour une personne.', 49, 'gin');
